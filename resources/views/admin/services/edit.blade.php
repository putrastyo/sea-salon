...
<div class="md:w-1/2 mt-6">
    <form action="{{route('services.update', $service)}}" method="post">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="border border-gray-300 p-2 rounded w-full" placeholder="Service name" value="{{$service->name}}">
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="number" name="duration" class="border border-gray-300 p-2 rounded w-full" placeholder="duration (in minute)" value="{{$service->duration}}">
            @error('duration')
                <p class="text-red-500">{{$message}}</p>
            @enderror
        </div>
